...
<body>
    ...
    <header>
        ...
        <p> <a href="uploadphoto.php" style="color: red;">Upload Photo</a> </p>
        
                            <?php } else{ ?>
                                <p><a href="login.php"><i class="flaticon-user"></i>login</a> | <a href="register.php">Sign up</a></p>
    <?php } ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-md-6">
                    <h3>Welcome to Ghumfir <br></h3>
                           <h2> Upload,Compete and Earn</h2>
                </div>
                <div class="col-xl-6 col-md-6">
                    <div class="add_here">
                        <a href="#">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="single_photography photography_bg_2">
                        <div class="info">
                            <div class="info_inner">
                                <h3><a href="#">Buddhist flag and the Himalayas <br>
                                        </a></h3>
                                <div class="date_catagory d-flex align-items-center justify-content-between">
                                    <span> visitnepal 2020</span>
                                    <span class="catagory">1920*1080</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="single_blog">
                                ...
                                <div class="blog_meta">
                                    <p><a href="#">Visitnepal2020</a></p>
                                    <h3><a href="#">
                                            Capture more with your lens <br> Word
                                        </a></h3>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="newsletter_text">
                            ...
                            <p>Get updates to our latest news and contents</p>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="newsform">
